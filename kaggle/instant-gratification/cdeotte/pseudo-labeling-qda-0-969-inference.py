...
#Source : https://www.kaggle.com/cdeotte/pseudo-labeling-qda-0-969/
...
def BuildFirstModel():
    ...
    for i in range(512):
        ...
        if not validTestData:
            print("WARNING : Zero length test data for "" i: ", i, " Length(train2): ", len(train2), " Length(test2): ", len(test2))
