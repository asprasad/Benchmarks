...
Aquifer_Auser = None
Water_Spring_Amiata = None
Lake_Bilancino = None
Water_Spring_Madonna_di_Canneto = None
Aquifer_Luco = None
Aquifer_Petrignano = None
Water_Spring_Lupa = None
River_Arno = None
datasets = None
datasets_names = None

def ReadData():
    global Aquifer_Doganella
    global Aquifer_Auser
    global Water_Spring_Amiata
    global Lake_Bilancino
    global Water_Spring_Madonna_di_Canneto
    global Aquifer_Luco
    global Aquifer_Petrignano
    global Water_Spring_Lupa
    global River_Arno
    global datasets
...
def Plot_Corr_Column(index, col):
    global datasets

    print('The earliest date: \t%s' %datasets[index].index.values[[0, -1]][0])
    print('The latest date: \t%s' %datasets[index].index.values[[0, -1]][1])

    corr_plot(datasets[index])

    columns_viz(datasets[index], color = col) #'#FFC30F')
...
def EDA_Corr_Column():
    Plot_Corr_Column(0, '#FFC30F')
    Plot_Corr_Column(1, '#FF5733')
    Plot_Corr_Column(2, '#C70039')
    Plot_Corr_Column(3, '#900C3F')
    Plot_Corr_Column(4, '#581845')
    Plot_Corr_Column(5, '#547980')
    Plot_Corr_Column(6, '#45ADA8')
    Plot_Corr_Column(7, '#9DE0AD')
    Plot_Corr_Column(8, '#474747')
...
def Model1_Lake_Bilancino():
    ...
    ## TODO The next model is an improved model and should be moved in to a separate function if possible.
...
def Model1_Aquifer_Petrignano():
    ...
    def PlotMonthlyDynamics_Aquifer_Petrignano():
    ...
    def PlotYearlyDynamics__Aquifer_Petrignano():
        fig, (ax1, ax2, ax3, ax4) = plt.subplots(4, 1, figsize = (15, 15))
...
def Model1_Aquifer_Auser():
    ...
    def PlotMonthlyDynamics_Aquifer_Auser():
    ...
    def PlotYearlyDynamics_Aquifer_Auser():
        fig, (ax1, ax2, ax3, ax4, ax5, ax6) = plt.subplots(6, 1, figsize = (15, 18))
...
def Model1_Aquifer_Doganella():
    ...
    def PlotMonthlyDynamics_Aquifer_Doganella():
    ...
    def PlotYearlyDynamics_Aquifer_Doganella():
        fig, (ax1, ax2, ax3, ax4) = plt.subplots(4, 1, figsize = (15, 12))
...
def Model1_Aquifer_Luco():
    ...
    def PlotMonthlyDynamics_Aquifer_Luco():
    ...
    def PlotYearlyDynamics_Aquifer_Luco():
        # Yearly dynamics
...
def Model1_Water_Spring_Madonna_di_Canneto():
    ...
    def PlotMonthlyDynamics_Water_Spring_Madonna_di_Canneto():
        fig, (ax1, ax2) = plt.subplots(2, 1, figsize = (15, 8))
    ...
    def PlotYearlyDynamics_Water_Spring_Madonna_di_Canneto():
        # Yearly dynamics
...
def Model1_Water_Spring_Lupa():
    ...
    def PlotMonthlyDynamics_Water_Spring_Lupa():
        fig, (ax1, ax2) = plt.subplots(2, 1, figsize = (15, 8))
    ...
    def PlotYearlyDynamics_Water_Spring_Lupa():
        # Yearly dynamics
...
def Model1_Water_Spring_Amiata():
    ...
    def PlotMonthlyDynamics_Water_Spring_Amiata():
        fig, (ax1, ax2, ax3, ax4) = plt.subplots(4, 1, figsize = (15, 12))
    ...
    # Yearly dynamics
    def PlotYearlyDynamics_Water_Spring_Amiata():
...
def RunTrainingAndInference():
    ReadData()
    Model1_Aquifer_Auser()
    Model1_Aquifer_Doganella()
    Model1_Aquifer_Luco()
    Model1_Aquifer_Petrignano()
    Model1_Lake_Bilancino()
    Model1_River_Arno()
    Model1_Water_Spring_Amiata()
